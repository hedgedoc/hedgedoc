...
ot.Client = (function (global) {
  ...
  StaleWithBuffer.prototype.applyClient = function (client, operation) {
    ...
    var swb = new StaleWithBuffer(this.acknowlaged, buffer, client, this.revision);
    swb.pendingOps = this.pendingOps;
    return swb;
  };
