...
const { Environment, ViewableBy, EditableBy } = require('./enum')
...
// Permission
config.viewableBy = ViewableBy
config.editableBy = EditableBy
if (!config.allowAnonymous) {
  delete config.viewableBy.anyone
  delete config.editableBy.anyone
}
if (!config.allowAnonymousEdits) {
  delete config.editableBy.anyone
}
