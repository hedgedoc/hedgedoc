...
let config = convict({
  ...
  tls: {
    enable: {
      doc: 'Set to use TLS server (if `true`, will auto turn on `protocolUseSSL`',
      format: 'Boolean',
      default: false
    },
    keyPath: {
      doc: 'TLS private key path absolute or relative to CodiMD\'s base directory',
      format: 'optional-path',
      default: ''
    },
    certPath: {
      doc: 'TLS certificate path absolute or relative to CodiMD\'s base directory',
      format: 'optional-path',
      default: ''
    },
    caPath: {
      doc: 'TLS CA certificate path absolute or relative to CodiMD\'s base directory',
      format: 'optional-path',
      default: ''
    },
    dhParamPath: {
      doc: 'TLS DH parameter absolute or relative to CodiMD\'s base directory',
      format: 'optional-path',
      default: ''
    },
  },
