...
export const NoteMetadataUpdateSchema = z
  .object({
    title: z
      .string()
      .describe('The new title of the note. Can not contain any markup and might be empty'),
    description: z
      .string()
...
export type NoteMetadataUpdateInterface = z.infer<typeof NoteMetadataUpdateSchema>
