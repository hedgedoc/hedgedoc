...
import { FileEarmarkRichtext as IconFileEarmarkRichtext } from 'react-bootstrap-icons'
 ...
 */
export const ExportStyledHtmlSidebarEntry: React.FC = () => {
  const { onClick } = useHtmlExportRequest(true)
