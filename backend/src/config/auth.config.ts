...
const schema = z.object({
  ...
  ldap: z.array(ldapSchema).optional().describe('HD_AUTH_LDAP_*'),
  oidc: z.array(oidcSchema).optional().describe('HD_AUTH_OIDC_*'),
});

export type AuthConfig = z.infer<typeof schema>;
export type LdapConfig = z.infer<typeof ldapSchema> & { providerName: string };
export type OidcConfig = z.infer<typeof oidcSchema> & { providerName: string };
