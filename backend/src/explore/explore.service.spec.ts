  ...
  describe('getMyNoteExploreEntries', () => {
    describe.each([
      ...
      [
        ...
        '',
        '',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note"."owner_id" = \$2 and "revision"."note_type" = \$3 order by "revision"."created_at" desc limit \$4/,
        [true, mockUserId, NoteType.SLIDE, ENTRIES_PER_PAGE_LIMIT],
      ],
      [
        'sorting',
        '',
      ...
      [
        ...
        '',
        'test',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note"."owner_id" = \$2 and \(LOWER\("revision"."title"\) LIKE \$3 OR LOWER\("revision_tag"."tag"\) LIKE \$4\) order by "revision"."created_at" desc limit \$5/,
        [true, mockUserId, '%test%', '%test%', ENTRIES_PER_PAGE_LIMIT],
      ],
    ] as [
      string,
      OptionalNoteType,
  ...
  describe('getSharedWithMeExploreEntries', () => {
    describe.each([
      [
        ...
        '',
        '',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note_user_permission" inner join "note" on "note_user_permission"."note_id" = "note"."id" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note_user_permission"."user_id" = \$2 order by "revision"."created_at" desc limit \$3/,
        [true, mockUserId, ENTRIES_PER_PAGE_LIMIT],
      ],
      [
        'type filter',
        ...
        '',
        '',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note_user_permission" inner join "note" on "note_user_permission"."note_id" = "note"."id" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note_user_permission"."user_id" = \$2 and "revision"."note_type" = \$3 order by "revision"."created_at" desc limit \$4/,
        [true, mockUserId, NoteType.SLIDE, ENTRIES_PER_PAGE_LIMIT],
      ],
      [
        'sorting',
      ...
      [
        ...
        '',
        'test',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note_user_permission" inner join "note" on "note_user_permission"."note_id" = "note"."id" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note_user_permission"."user_id" = \$2 and \(LOWER\("revision"."title"\) LIKE \$3 OR LOWER\("revision_tag"."tag"\) LIKE \$4\) order by "revision"."created_at" desc limit \$5/,
        [true, mockUserId, '%test%', '%test%', ENTRIES_PER_PAGE_LIMIT],
      ],
    ] as [
      string,
  ...
  describe('getPublicNoteExploreEntries', () => {
    describe.each([
      [
        ...
        '',
        '',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note_group_permission" inner join "note" on "note_group_permission"."note_id" = "note"."id" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note_group_permission"."group_id" = \$2 order by "revision"."created_at" desc limit \$3/,
        [true, mockEveryoneGroupId, ENTRIES_PER_PAGE_LIMIT],
      ],
      [
        'type filter',
        NoteType.SLIDE,
        '',
        '',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note_group_permission" inner join "note" on "note_group_permission"."note_id" = "note"."id" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note_group_permission"."group_id" = \$2 and "revision"."note_type" = \$3 order by "revision"."created_at" desc limit \$4/,
        [true, mockEveryoneGroupId, NoteType.SLIDE, ENTRIES_PER_PAGE_LIMIT],
      ],
      [
        'sorting',
        '',
      ...
      [
        ...
        '',
        'test',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note_group_permission" inner join "note" on "note_group_permission"."note_id" = "note"."id" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "note_group_permission"."group_id" = \$2 and \(LOWER\("revision"."title"\) LIKE \$3 OR LOWER\("revision_tag"."tag"\) LIKE \$4\) order by "revision"."created_at" desc limit \$5/,
        [true, mockEveryoneGroupId, '%test%', '%test%', ENTRIES_PER_PAGE_LIMIT],
      ],
    ] as [
      string,
      OptionalNoteType,
  ...
  describe('getMyPinnedNoteExploreEntries', () => {
    it('correctly return all pinned notes of the user', async () => {
      mockQuery(
        'select',
        tracker,
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "user_pinned_note" inner join "note" on "user_pinned_note"."note_id" = "note"."id" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "user_pinned_note"."user_id" = \$2 order by "revision"."created_at" desc/,
        selectedRows,
      );
      ...
      expectBindings(tracker, 'select', [[true, mockUserId]]);
    });
  });
  describe('getRecentlyVisitedNoteExploreEntries', () => {
    describe.each([
      [
        ...
        '',
        '',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag", "visited_notes"."visited_at" as "lastVisitedAt" from "note" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "visited_notes"."user_id" = \$2 order by "revision"."created_at" desc limit \$3/,
        [true, mockUserId, ENTRIES_PER_PAGE_LIMIT],
      ],
      [
        'type filter',
        ...
        '',
        '',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag", "visited_notes"."visited_at" as "lastVisitedAt" from "note" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "visited_notes"."user_id" = \$2 and "revision"."note_type" = \$3 order by "revision"."created_at" desc limit \$4/,
        [true, mockUserId, NoteType.SLIDE, ENTRIES_PER_PAGE_LIMIT],
      ],
      [
        'sorting',
      ...
      [
        ...
        '',
        'test',
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag", "visited_notes"."visited_at" as "lastVisitedAt" from "note" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "alias"."is_primary" = \$1 and "visited_notes"."user_id" = \$2 and \(LOWER\("revision"."title"\) LIKE \$3 OR LOWER\("revision_tag"."tag"\) LIKE \$4\) order by "revision"."created_at" desc limit \$5/,
        [true, mockUserId, '%test%', '%test%', ENTRIES_PER_PAGE_LIMIT],
      ],
    ] as [
      string,
  ...
  describe('setNotePinStatus', () => {
    it('pins note', async () => {
      ...
      mockQuery(
        'select',
        tracker,
        /select "alias"."alias" as "primaryAlias", "revision"."title" as "title", "revision"."note_type" as "noteType", "user"."username" as "ownerUsername", "note"."created_at" as "createdAt", "revision"."created_at" as "lastChangedAt", "revision"."uuid" as "revisionUuid", "revision_tag"."tag" as "tag" from "note" inner join "alias" on "alias"."note_id" = "note"."id" inner join "user" on "user"."id" = "note"."owner_id" left join "visited_notes" on "visited_notes"."note_id" = "note"."id" inner join \(select "uuid", "note_id", max\("created_at"\) from "revision" group by "note_id"\) as "latest_revision" on "latest_revision"."note_id" = "note"."id" inner join "revision" on "revision"."note_id" = "note"."id" and "revision"."uuid" = "latest_revision"."uuid" left join "revision_tag" on "revision_tag"."revision_id" = "revision"."uuid" where "note"."id" = \$1 and "alias"."is_primary" = \$2/,
        selectedRows,
      );
