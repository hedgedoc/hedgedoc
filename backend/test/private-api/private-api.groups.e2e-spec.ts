...
describe('Groups', () => {
  ...
  let _agentNotLoggedIn: request.SuperAgentTest;
  let _agentGuestUser: request.SuperAgentTest;
  let agentUser1: request.SuperAgentTest;
  let _agentUser2: request.SuperAgentTest;
  ...
  beforeEach(async () => {
    ...
    [_agentNotLoggedIn, _agentGuestUser, agentUser1, _agentUser2] =
