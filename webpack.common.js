...
module.exports = {
  ...
  entry: {
    ...
    'index-styles': [
      ...
      path.join(__dirname, 'public/vendor/codemirror-hackmd/theme/one-dark.css'),
      path.join(__dirname, 'node_modules/codemirror/mode/tiddlywiki/tiddlywiki.css'),
      path.join(__dirname, 'public/vendor/codemirror-hackmd/mode/mediawiki/mediawiki.css'),
    ...
    'index-pack': [
      ...
      'expose-loader?LZString!lz-string',
      'script-loader!codemirror',
      path.join(__dirname, 'public/vendor/codemirror-hackmd/addons.js'),
      'script-loader!inlineAttachment',
      'script-loader!jqueryTextcomplete',
      'script-loader!codemirrorSpellChecker',
      'script-loader!codemirrorInlineAttachment',
