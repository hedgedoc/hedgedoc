...
HedgeDoc uses a vendored version of OT.js. The source code lives under `public/vendor/ot/`.
The HedgeDoc frontend uses a minified build `public/vendor/ot/ot.min.js`.
